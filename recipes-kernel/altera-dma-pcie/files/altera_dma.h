...
// MAX_NUM_DWORDS*4 should probably not exceed PAGE_SIZE
// It was 4096 originally
#define MAX_NUM_DWORDS ALTERA_DMA_NUM_DWORDS
...
#define RD_CTRL_BUF_BASE_LOW 0x01000000
#define RD_CTRL_BUF_BASE_HI 0x01001FFF
#define WR_CTRL_BUF_BASE_LOW 0x01002000
#define WR_CTRL_BUF_BASE_HI 0x01003FFF
#define BAR 4
#define DMAMASK 64
...
static int scan_bars(struct altera_pcie_dma_bookkeep *bk_ptr,
		     struct pci_dev *dev) __init;
static int map_bars(struct altera_pcie_dma_bookkeep *bk_ptr,
		    struct pci_dev *dev) __init;
static int dma_test(struct altera_pcie_dma_bookkeep *bk_ptr,
		    struct pci_dev *dev);
//static irqreturn_t dma_isr(int irq, void *dev_id);

static int altera_pci_probe(struct pci_dev *dev,
